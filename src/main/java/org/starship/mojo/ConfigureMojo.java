...
import org.starship.util.ui.UiRunnerUtil;
...
public class ConfigureMojo extends AbstractMojo {
    ...
    public void execute() {
        ...
        getLog().info("***********************************************************");
        try {
            UiRunnerUtil uiRunnerUtil = new UiRunnerUtil(this);
            uiRunnerUtil.runUi(this);
        } catch (Exception e) {
            getLog().error("Failed to launch UI: " + e.getMessage());
